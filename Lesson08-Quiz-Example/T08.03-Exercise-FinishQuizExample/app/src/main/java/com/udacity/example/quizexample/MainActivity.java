...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDef = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        if (mData != null) {
            ...
            mDef.setVisibility(View.INVISIBLE);
            mButton.setText(getString(R.string.show_definition));

            mWord.setText(mData.getString(wordIndex));
            mDef.setText(mData.getString(defIndex));
