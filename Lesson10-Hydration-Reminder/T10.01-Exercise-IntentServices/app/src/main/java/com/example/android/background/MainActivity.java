...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent intentForService = new Intent(MainActivity.this, WaterReminderIntentService.class);
        // TODO (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        intentForService.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
