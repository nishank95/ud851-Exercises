...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String>{
    ...
    private static final int GITHUB_SEARCH_LOADER = 464;
    ...
    private void makeGithubSearchQuery() {
        ...
        qbundle.putString(SEARCH_QUERY_URL_EXTRA,githubSearchUrl.toString());
        ...
        if(loader == null){
            loaderManager.initLoader(GITHUB_SEARCH_LOADER,qbundle,this);
        }
        else{
            loaderManager.restartLoader(GITHUB_SEARCH_LOADER,qbundle,this);
        }
    ...
    public Loader<String> onCreateLoader(int i, final Bundle args) {
        return new  AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                String displayUrl=args.getString(SEARCH_QUERY_URL_EXTRA);
                if(displayUrl ==null | TextUtils.isEmpty(displayUrl)){
                    return null;
                }
                try {
                    URL githubSearchUrl=new URL(displayUrl);
