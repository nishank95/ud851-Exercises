...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        colorValue=ColorUtils.getViewHolderBackgroundColorFromInstance(context,viewHolderCount);
        viewHolder.itemView.setBackgroundColor(colorValue);
        // TODO (15) Increment viewHolderCount and log its value
        viewHolderCount++;
        Log.d("#", String.valueOf(colorValue));
        return viewHolder;
    }
